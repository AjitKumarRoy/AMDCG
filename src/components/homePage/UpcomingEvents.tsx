      ...
      <div className="flex-grow space-y-4 h-[350px] overflow-y-auto pr-2 custom-scrollbar ">
        {upcomingEvents.length > 0 ? (
          ...
          {/* --- THIS LINK STRUCTURE IS NOW CORRECTED --- */}
                <Link href={event.link} className="text-sm group flex items-center justify-between rounded-lg p-3 transition-colors duration-300 hover:bg-white/10 border border-white/10" target="_blank">
